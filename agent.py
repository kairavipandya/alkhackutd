    ...
    with col2:
        ...
        with st.container():
            st.markdown("""
                <div style='background-color: #CE0606; padding: 10px; border-radius: 5px;'>
                    <p style='text-align: center; color: white;'><b><u>Customer Profile</u></b></p>
                    <p><b>Name: Jane Doe</b> </p>
                    <p><b>ID:</b> 463764329 </p>
                    <p><b>Customer Address:</b> 123 Main St. Frisco, TX </p>
                    <p><b>Business Name:</b> Jane's Bakery </p>
                    <p><b>Business Address:</b> 456 Main St. Frisco, TX </p>
        ...
        with col1_1:
            ...
            with st.container():
                st.markdown("""
                    <div style='background-color: #CE0606; padding: 10px; border-radius: 5px;'>
                        <p style='text-align: center; color: white;'><b><u>Chat Summary</u></b></p>
...
with col1:
    ...
    st.write("Pick an appointment to display overview.")

    # Appointment slot buttons
    if st.button('9:00 am'):
        st.success('Appointment Overview Displayed!')
        display_overview()

    if st.button('10:00 am'):
        st.success('Appointment Overview Displayed!')
        display_overview()

    if st.button('11:00 am'):
        st.success('Appointment Overview Displayed!')
        display_overview()

    if st.button('12:00 pm'):
        st.success('Appointment Overview Displayed!')
        display_overview()

    if st.button('1:00 pm'):
        st.success('Appointment Overview Displayed!')
        display_overview()

    if st.button('2:00 pm'):
        st.success('Appointment Overview Displayed!')
        display_overview()

    if st.button('3:00 pm'):
        st.success('Appointment Overview Displayed!')
        display_overview()
